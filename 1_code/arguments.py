...
def get_args():
    ...
    parser.add_argument('-transformer_eff_model_seed', type=int, default=9, help='transformer eff model seed')
    parser.add_argument('-transformer_vout_model_seed', type=int, default=9, help='transformer vout model seed')
    ...
    parser.add_argument('-reward_model', type=str, default='only_max_reg_reward-5-0.pt', help='file of model that predicts both eff and vout')
