...
class Autopo(InMemoryDataset):
    ...
    def __init__(self, root, path, y_select,  transform=None, pre_transform=None, data_path_root=None , ncomp=3):
    ...
    def get_tmp(self):
        ...
        for item in json_file:
            ...
            edge_attr2=torch_geometric.utils.to_dense_adj(torch.tensor(edge_index),None,torch.torch.tensor(edge_attr_new2),len(node_attr_new))[0]
