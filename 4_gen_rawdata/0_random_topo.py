...
if __name__ == '__main__':
    ...
    parser.add_argument('-n_topology', type=int, default=100000,
...
#            print(path)
            ...
            if not check_topo_path(path, prohibit_path) or not check_switch(path) or check_redundant_loop(list_of_node,list_of_edge):
