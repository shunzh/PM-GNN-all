...
def get_args():
    ...
    parser.add_argument('-sweep', action='store_true', default=False, help='sweep parameters')
    ...
    parser.add_argument('-eff_model', type=str, default='reg_eff-3-5.pt', help='eff model file name')
    parser.add_argument('-vout_model', type=str, default='reg_vout-4-5.pt', help='vout model file name')
